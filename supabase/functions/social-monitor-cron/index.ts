...
const GEN_PROMPT = `Generate 2 realistic, DISTINCT social media posts (in Spanish, English, or French — mix languages) about possible airline incidents happening RIGHT NOW. Mix risk levels: include 1 likely real incident (delay, safety, customer treatment, outage, etc.) and 1 lower-risk or noise post (joke, vague complaint, or unrelated). Vary airlines (Iberia, Air France, LATAM, Avianca, Vueling, Ryanair...), routes (MAD-BCN, CDG-JFK, BOG-MIA...), and flight numbers.
